...
- (instancetype)init {
    self = [super init];
    if (self) {
        UIImage *image = [UIImage imageNamed:@"tab_see_nor"];
        UIImage *selectedImage = [[UIImage imageNamed:@"tab_see_press"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        self.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"音乐" image:image selectedImage:selectedImage];
